...
{ 
    ...
    */ 
    ...
    { 
        ...
        dummyMacData.addElement(new MachineData(new Integer(100), "Robert", "288.209.140.223","Win NT", "Engineering")); 
        dummyMacData.addElement(new MachineData(new Integer(105), "Rahul", "288.209.140.214","Solaris 5", "Engineering")); 
        dummyMacData.addElement(new MachineData(new Integer(110), "Daina", "288.209.140.220","HP UX", "Engineering")); 
        dummyMacData.addElement(new MachineData(new Integer(106), "Vijay", "288.209.140.215","Win NT", "Engineering")); 
        dummyMacData.addElement(new MachineData(new Integer(302), "Andy", "288.209.142.203","Win 98", "Human Resource")); 
        dummyMacData.addElement(new MachineData(new Integer(504), "Tom", "288.209.141.207","Win NT", "Marketing")); 
        dummyMacData.addElement(new MachineData(new Integer(104), "Bill", "288.209.140.222","Win NT", "Engineering")); 
