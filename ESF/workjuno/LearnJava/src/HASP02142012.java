...
class  HASP02142012{
	public static void main(String[] args){
		...
		try{ 
			...
			//ResultSet rsAll = stAll.executeQuery("SELECT * FROM CSHEM.SHASPTEST");
			ResultSet rsAll = stAll.executeQuery("select * from test.epa_site;");
			...
			ResultSet rs=st.executeQuery("select * from test.epa_site where siteNumber = 1"); 
			String name="",address="";
			if(rs.next()){
				name=rs.getString("Site");
