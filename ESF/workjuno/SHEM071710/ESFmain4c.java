...
public class ESFmain4c extends JFrame implements ActionListener {
    ...
    public ESFmain4c() {
        super("ESF Database Application, Version 0.04c");
    ...
    //Create a new internal frameConn. need to re-do, why desktop not working 
    protected void createConnFrame() throws SQLException {
        //ESFConnFrame1 frameConn = new ESFConnFrame1();
        PeriTable4d frameConn = new PeriTable4d();
        frameConn.setVisible(true); //necessary as of 1.3
        //desktop.add(frameConn);
        //try {
        //    frameConn.setSelected(true);
        //} catch (java.beans.PropertyVetoException e) {}
    }
