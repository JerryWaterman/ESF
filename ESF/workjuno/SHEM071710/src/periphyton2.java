...
public class periphyton2{
	...
	TO DO  read in file    12-08-08
     ...
     -------------------------------F I E L D S------D A T A------------------------------ 
                                          1     2    3    4    5    6       7      8        9    
     insert into test.jerryperiphyton ( pdate, sid, lid, cid, rep, matrix, ptype, name, volafterwash_mL,
             10                 11              12               13              14                15
     predilutionaliquid_mL, 1stdilution_mL, 1stsubsample_mL, 2nddilution_ml, 2ndsubsamlpe_mL, 3rddilution_mL,
           16                  17                     18                  19                   20
     47mmfiltervolume_mL, 25mmfiltervolume_mL, chlafiltervolume_mL, 47mmboatfilterwt_g,  47mmafterdrying_g,
           21                   22                23                 24         25          26            
     47mmwtafterashing_g, 25mmboatfilterwt_g, 25mmwtafterdrying_g, foilwt_g, foilname, foilareawtslope, 
       27       28         
     chla_ug, comments)  
     ...
     -------------------------------F I E L D S------------------------------------     
	*/
    File file = new File("C:\\Temp\\perifile.txt");
    Scanner fileIn = new Scanner(file);
    String insertfields = "insert into test.jerryperiphyton (pdate,sid,lid,cid,rep,matrix,ptype," +
    		"name,volafterwash_mL, predilutionaliquid_mL, 1stdilution_mL, 1stsubsample_mL, " +
    		"2nddilution_ml, 2ndsubsamlpe_mL, 3rddilution_mL, 47mmfiltervolume_mL," +
    		"25mmfiltervolume_mL, chlafiltervolume_mL, 47mmboatfilterwt_g,  47mmafterdrying_g," +
    		"47mmwtafterashing_g, 25mmboatfilterwt_g, 25mmwtafterdrying_g, foilwt_g, foilname, " +
    		"foilareawtslope,chla_ug, comments) values \r\n";
    String insertdata   = null;
    while (fileIn.hasNext()){
	    String cLine= fileIn.nextLine();
	    String str = cLine;                                               //
	   	String vtemp = "";
	   	String vs1  = "null"; //pdate
	   	...
	   	Writer output = new BufferedWriter(new FileWriter("C:\\Temp\\perioutfile.txt",true));
	    try {
