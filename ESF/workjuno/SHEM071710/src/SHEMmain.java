 ...
 */
public class SHEMmain extends JFrame implements ActionListener {
    /**
	 * 
	 */
    ...
    public SHEMmain() {
        super("SHEM Database Application, Version 0.01b");
    ...
    public JMenuBar createMenuBar() {
        ...
        menuItem.setActionCommand("HASPdata");
        menuItem.addActionListener(this);
        menu.add(menuItem);                 
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if ("HASPdata".equals(e.getActionCommand())) { 
