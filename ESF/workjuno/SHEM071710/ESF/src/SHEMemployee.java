...
public class SHEMemployee{
	...
	TO DO  read in file    12-08-08
     ...
     -------------------------------F I E L D S------------------------------------     
	*/
    File file = new File("C:\\Temp\\employExcelcvs.txt");
    Scanner fileIn = new Scanner(file);
    // check for Oracle
    String insertfields = "insert into test.jerrysediment (collectiondate,placementdate,sampleID,elapsetimeday" +
    		"channeltype,channelid,analyticalbase,longchannelid,crosschannelid,cobblessamplertray," +
    		"porosityfinalwet,porosityfinaldry,porosityporocity,gt2mmfractionperiphyt,) values \r\n";
