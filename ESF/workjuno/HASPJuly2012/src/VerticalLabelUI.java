 ...
 *
 * The default rotation is anticlockwise (vertical up).
 * To rotate the label clockwise (vertical down) 
 * pass a parameter of true to the constructor:
 * 
...
public class VerticalLabelUI extends BasicLabelUI {
   ...
   /**
    * Constructs a VerticalLabelUI with the default anticlockwise
    * rotation
    */
   ...
   public int getBaseline(JComponent c, int width, int height) {
      ...
      System.out.println("getBaseline "+super.getBaseline(c, width, height));
      return -1;
   }
   ...
   public Component.BaselineResizeBehavior getBaselineResizeBehavior(
      ...
      System.out.println("base line ResizeBehavior "+super.getBaselineResizeBehavior(c));
