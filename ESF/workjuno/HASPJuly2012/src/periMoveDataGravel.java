...
public class periMoveDataGravel{
	...
	*/
    File file = new File("C:\\Temp\\testgravel.txt");
    ...
    while (fileIn.hasNext()){
	  ...
	  vs43 = "'JDW',";
	        ...
	        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
	   		vs44 = " timestamp '"+ dateFormat.format(calendar.getTime())+ " 00:00:00', ";
	   		System.out.println("vs34 = "+vs34);
	   		
	   		vs45 = null+",";
	   		vs46 = null+",";
	   		vs47 = "'Gravel',";
	   		vs48 = "'Don 11-12 update atrazine periphyton summary'";
	   	...
	   	insertdata = "("+vs2+vs3+vs4+vs5+vs6+vs7+vs8+vs9+vs10+vs11+vs12+vs13+vs14+vs15+vs16+vs17+vs18+vs19+vs20+vs21+vs22+vs23+vs24+vs25+vs26+vs27+vs28+vs29+vs30+vs31+vs32+vs33+vs34+vs35+vs36+vs37+vs38+vs39+vs40+vs41+vs42+vs43+vs44+vs45+vs46+vs47+vs48+
	   	")," + "\r\n";
	   	System.out.println("vinsert is:    " + insertdata);
	   	Writer output = new BufferedWriter(new FileWriter("C:\\Temp\\Graveloutfile.txt",true));
	    try {
