...
public class HASPInternalFrame implements ActionListener {
	...
	*/	
	 ...
	 * @param headers
	 */
	public HASPInternalFrame(String[] headers){
		...
		frame.setLocation(dim.width / 2 - frame.getWidth() / 2, dim.height / 2
 	    ...
 	    frame.setTitle("Set up the data for the Periphyton table. Ver. 0.1 July 21, 2009");
