 ...
 * http://weblogs.java.net/blog/joconner/archive/2006/10/more_informatio.html
  */
public class SHEMInputFrame extends JFrame {
    /**
	 * 
	 */
	...
	public SHEMInputFrame() {
        ...
        //qtm.setHostURL(hostField.getText().trim());//705
        //qtm.setQuerySQL(queryField.getText().trim());//484
        //qtm.setQuery();//723
        
        
        System.out.println("field data "+ hostField);
...
//      westenfall 512 high st. 513 248 0999             06vhdb000
	...
	private void SQL_query(String trim) {
